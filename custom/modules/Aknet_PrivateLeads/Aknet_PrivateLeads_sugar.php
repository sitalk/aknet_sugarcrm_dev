 ...
 * PLACE ANY CUSTOMIZATIONS IN Aknet_PrivateLeads
 */

require_once('include/SugarObjects/templates/person/Person.php');

class Aknet_PrivateLeads_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'Aknet_PrivateLeads';
	var $object_name = 'Aknet_PrivateLeads';
	var $table_name = 'Aknet_privateleads';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $house_number;
		var $address_street;
		var $address_commentary;
		var $status_commentary;
		var $status;
		var $private_lead_source;
		var $pr_lead_source_description;
		var $status_description;
		function Aknet_PrivateLeads_sugar(){	
		parent::Person();
	}
