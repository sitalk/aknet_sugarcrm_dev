...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Заявка Ч. Сектор List',
  'LBL_MODULE_NAME' => 'Заявка Ч. Сектор',
  'LBL_MODULE_TITLE' => 'Заявка Ч. Сектор',
  'LBL_HOMEPAGE_TITLE' => 'My Заявка Ч. Сектор',
  'LNK_NEW_RECORD' => 'Create Заявка Ч. Сектор',
  'LNK_LIST' => 'View Заявка Ч. Сектор',
  'LNK_IMPORT_C_PRIVATELEADS' => 'Импорт Заявка Ч. Сектор',
  'LBL_SEARCH_FORM_TITLE' => 'Search Заявка Ч. Сектор',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activities',
  'LBL_AKNET_PRIVATELEADS_SUBPANEL_TITLE' => 'Заявка Ч. Сектор',
  'LBL_NEW_FORM_TITLE' => 'New Заявка Ч. Сектор',
  'LBL_MIDDLE_NAME' => 'Отчество',
  'LBL_STREET_NAME' => 'Улица',
  'LBL_STREET_NUMBER' => 'Номер дома',
  'LBL_HOUSE_NUMBER' => 'Номер дома',
  'LBL_ADDRESS_STREET' => 'Улица',
  'LBL_ADDRESS_COMMENTARY' => 'Комментарий к адресу',
  'LBL_STATUS_COMMENTARY' => 'Комментарий ',
  'LBL_STATUS' => 'Status:',
  'LBL_PRIVATE_LEAD_SOURCE' => 'Источник заявки',
  'LBL_PRIVATE_LEAD_SOURCE_DESCRIPTION' => 'Описание источника заявки:',
