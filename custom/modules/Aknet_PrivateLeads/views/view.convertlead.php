...
class ViewConvertAknetPrivateLead extends SugarView
{
    protected $fileName = "modules/Aknet_PrivateLeads/metadata/convertdefs.php";
    ...
    public function display()
    {
        ...
        $editviewFile = 'modules/Aknet_PrivateLeads/metadata/editviewdefs.php';
        ...
        $smarty->assign("module", "Aknet_PrivateLeads");
        $smarty->assign("view", "convertlead");
        $smarty->assign("bean", $this->focus);
        $smarty->assign("record_id", $this->focus->id);
        global $mod_strings;
        $smarty->assign('MOD', $mod_strings);
        $smarty->display("modules/Aknet_PrivateLeads/tpls/ConvertLeadHeader.tpl");
        ...
        foreach($this->defs as $module => $vdef)
        {
            ...
            $ev->setup($module, $focus, $this->medataDataFile, "modules/Aknet_PrivateLeads/tpls/ConvertLead.tpl", false);
            $ev->process();
        ...
        $smarty->assign("bean", $this->focus);
        $smarty->display("modules/Aknet_PrivateLeads/tpls/ConvertLeadFooter.tpl");
    }
