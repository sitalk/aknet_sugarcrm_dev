...
class Aknet_PrivateLeads_Hooks {

    private function syncService($lead, $target, $service) {
        $relationship = "aknet_service{$service}_aknet_privateleads_1";
    ...
    public function syncServices(Aknet_PrivateLeads $lead, $event, $arguments) {
        if ($lead) {
