...
class TemplateField{
	...
	//		'default'=>'default_value',
		...
		'options'=>'ext1',
		'help'=>'help',
		'module_name_input'=>'module_name_input',
	    'comments'=>'comment',
	...
	function get_field_def(){
		$array =  array(
			...
			'module_name_input'=> (isset($this->module_name_input)) ? $this->module_name_input : '',
	...
	function populateFromRow($row=array()) {
		$fmd_to_dyn_map = array('comments' => 'comment', 'module_name_input'=> 'module_name_input', 'require_option' => 'required', 'label' => 'vname',
