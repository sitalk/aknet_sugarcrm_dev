...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='address_house_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_ADDRESS_HOUSE_C' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<td valign="top" width='37.5%' >
{counter name="panelFieldCount"}
<input type='hidden' name='{$fields.address_house_c.name}' id="{$fields.address_house_c.name}-value" 
value='{$fields.address_house_c.value}'>
<input id="{$fields.address_house_c.name}-input" value='{sugar_dictionary table= idField= nameField= value=$fields.address_house_c.value }' data-name="{$fields.address_house_c.name}"/>
...
var field = $( "#{$fields.address_house_c.name}-input") ;
var moduleName = "Aknet_Street";
...
field.autocomplete({
    source: function( request, response ) {
        ...
        data.push({label: '<input type="button" name="btn_name_field" id="btn_name_field" title="Create" class="button firstChild" value="Добавить новый" onclick=\'open_popup("Aknet_House", 400, 180, "", true, false,  {"call_back_function":"set_return","form_name":"EditView"}, "single", true )\'>'}); 
        response(data);
    },
    minLength: 2,
...
<td valign="top" id='appartment_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_APPARTMENT' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.appartment_c.value) <= 0}
{assign var="value" value=$fields.appartment_c.default_value }
{else}
{assign var="value" value=$fields.appartment_c.value }
{/if}  
<input type='text' name='{$fields.appartment_c.name}' 
id='{$fields.appartment_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='address_commentary_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_ADDRESS_COMMENTARY' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if empty($fields.address_commentary_c.value)}
{assign var="value" value=$fields.address_commentary_c.default_value }
{else}
{assign var="value" value=$fields.address_commentary_c.value }
{/if}  
<textarea  id='{$fields.address_commentary_c.name}' name='{$fields.address_commentary_c.name}'
rows="4" 
cols="80" 
title='' tabindex="0" 
 >{$value}</textarea>
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='status_commnetary_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_STATUS_COMMNETARY' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if empty($fields.status_commnetary_c.value)}
{assign var="value" value=$fields.status_commnetary_c.default_value }
{else}
{assign var="value" value=$fields.status_commnetary_c.value }
{/if}  
<textarea  id='{$fields.status_commnetary_c.name}' name='{$fields.status_commnetary_c.name}'
rows="4" 
cols="80" 
title='' tabindex="0" 
 >{$value}</textarea>
...
addToValidate('EditView', 'address_house_c', 'dictionary', false,'{/literal}{sugar_translate label='LBL_ADDRESS_HOUSE_C' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'address_commentary_c', 'text', false,'{/literal}{sugar_translate label='LBL_ADDRESS_COMMENTARY' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'appartment_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_APPARTMENT' module='Leads' for_js=true}{literal}' );
...
addToValidate('EditView', 'status_commnetary_c', 'text', false,'{/literal}{sugar_translate label='LBL_STATUS_COMMNETARY' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', '_c', 'dictionary', false,'{/literal}{sugar_translate label='' module='Leads' for_js=true}{literal}' );
...
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_assigned_user_name']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\u041d\u0435\u0442 \u0421\u043e\u0432\u043f\u0430\u0434\u0435\u043d\u0438\u0439"};</script>{/literal}
