 ...
 * PLACE ANY CUSTOMIZATIONS IN Aknet_BusinessLeads
 */

require_once('include/SugarObjects/templates/person/Person.php');

class Aknet_BusinessLeads_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'Aknet_BusinessLeads';
	var $object_name = 'Aknet_BusinessLeads';
	var $table_name = 'aknet_businessleads';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		function c_BusinessLeads_sugar(){	
		parent::Person();
	}
