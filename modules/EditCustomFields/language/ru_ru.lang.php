 ...
 * *******************************************************************************/
 $mod_strings = array (
  'LBL_MODULE_NAME' => 'Изменение пользовательских полей',
  'LBL_ADD_FIELD' => 'Добавить поле:',
  'LBL_MODULE_TITLE' => 'Изменение пользовательских полей',
  ...
  'COLUMN_TITLE_LABEL_VALUE' => 'Подпись',
  ...
  'COLUMN_TITLE_LABEL_COLS' => 'Колонки',
  'COLUMN_TITLE_DISPLAYED_ITEM_COUNT' => '# элементов отображено',
  'COLUMN_TITLE_AUTOINC_NEXT' => 'Автоинкремент',
  'COLUMN_DISABLE_NUMBER_FORMAT' => 'Не использовать разделитель',
  'LBL_DROP_DOWN_LIST' => 'Чекбокс',
  'LBL_RADIO_FIELDS' => 'Радиобокс',
  'LBL_MULTI_SELECT_LIST' => 'Мульти Выбор',
  ...
  'LBL_DEPENDENT_CHECKBOX' => 'Зависимость',
